...
<aside id="sidebar" class="fixed top-0 left-0 w-56 h-full bg-sidebar-bg text-sidebar-text shadow-xl flex flex-col z-40 transform -translate-x-full md:translate-x-0 transition-transform duration-300 overflow-y-auto">
    ...
    <nav class="flex-grow p-4 space-y-1.5">
        ...
        <p class="pt-4 pb-1 px-3 text-xs uppercase tracking-widest text-gray-400 font-medium">Core Management</p>

        <a href="../pages/subjects.php" class="flex items-center space-x-3 p-3 rounded-lg transition duration-150 focus:outline-none focus:ring-2 focus:ring-white/50
            <?php echo ($current_page == 'subjects.php') ? 'bg-white bg-opacity-20 text-white' : 'text-white hover:bg-primary-hover'; ?>">
