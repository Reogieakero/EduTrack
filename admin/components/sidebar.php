...
<aside id="sidebar" class="fixed top-0 left-0 w-56 h-full bg-sidebar-bg text-sidebar-text shadow-xl flex flex-col z-40 transform -translate-x-full md:translate-x-0 transition-transform duration-300 overflow-y-auto">
    ...
    <nav class="flex-grow p-4 space-y-1.5">
        <a href="dashboard.php" class="flex items-center space-x-3 p-3 rounded-lg font-semibold transition duration-150 focus:outline-none focus:ring-2 focus:ring-white/50
        ...
        <a href="sections.php" class="flex items-center space-x-3 p-3 rounded-lg transition duration-150 focus:outline-none focus:ring-2 focus:ring-white/50
            <?php echo ($current_page == 'sections.php') ? 'bg-white bg-opacity-20 text-white' : 'text-white hover:bg-primary-hover'; ?>">
            <i data-lucide="layers" class="w-5 h-5"></i>
            <span>Section</span>
        </a>

        <a href="students.php" class="flex items-center space-x-3 p-3 rounded-lg transition duration-150 focus:outline-none focus:ring-2 focus:ring-white/50
    ...
    <div class="p-4 border-t border-primary-hover/50 flex-shrink-0">
        ...
        <a href="logout.php" class="w-full flex items-center justify-center space-x-3 p-3 mt-2 rounded-lg bg-red-600 hover:bg-red-700 text-white font-medium transition duration-150 focus:outline-none focus:ring-2 focus:ring-red-300">
