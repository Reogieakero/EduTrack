    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-sm mx-4 transform transition-all duration-300 scale-95 opacity-0" id="successModalContent">
        <div class="p-6 text-center">
            <div class="flex flex-col items-center justify-center">
                ...
                <p class="text-gray-500 mb-5">The new section has been saved to the database.</p>
            </div>
            ...
            <button id="closeSuccessModalBtn" class="w-full bg-primary-blue hover:bg-blue-700 text-white font-semibold py-2.5 px-6 rounded-lg transition duration-150 shadow-md">
                Got It
            </button>
        </div>
    </div>
